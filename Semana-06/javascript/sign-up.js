...
window.onload = function() {
    ...
    var errorFirstName = document.createElement("label");
    var errorLastName = document.createElement("label");
    var errorDni = document.createElement("label");
    var errorDate = document.createElement("label");
    var errorTel = document.createElement("label");
    var errorAddress = document.createElement("label");
    var errorLocality = document.createElement("label");
    var errorPostalCode = document.createElement("label");
    var errorEmail = document.createElement("label");
    var errorPassword = document.createElement("label");
    var errorRepeatPassword = document.createElement("label");
